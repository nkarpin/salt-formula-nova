...
nova_cell1_create:
  ...
  {%- endif %}
    ...
    {%- for cell_name, cell in cells.items() %}
      ...
      {%- if cell.database.get('x509',{}).get('enabled',False) or cfg.get('database', {}).get('x509',{}).get('enabled',False) %}
      ...
      {%- elif cell.database.get('ssl',{}).get('enabled',False) or cfg.get('database', {}).get('ssl',{}).get('enabled',False) %}
